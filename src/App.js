...
function App() {
  const baseUrl = "https://139.59.4.162:6900";
  ...
  return (
    <>
      <Routes>
        ...
        <Route
          path="/admin/login"
          element={<AuthAdmin cmp={LoginAdmin} baseUrl={baseUrl} />}
        />
        <Route
          path="/admin"
          element={<AuthAdmin cmp={AdminPage} baseUrl={baseUrl} />}
        />
        <Route
          path="/user/management"
          element={<AuthAdmin cmp={UserManagement} baseUrl={baseUrl} />}
        />
        <Route
          path="/user/pages"
          element={<AuthAdmin cmp={Pages} baseUrl={baseUrl} />}
        />
        <Route
          path="/Promotions"
          element={<AuthAdmin cmp={Promotions} baseUrl={baseUrl} />}
        />
        <Route
          path="/Order"
          element={<AuthAdmin cmp={Order} baseUrl={baseUrl} />}
        />
        <Route
          path="/GameResult"
          element={<AuthAdmin cmp={GameResult} baseUrl={baseUrl} />}
        />
        <Route
          path="/GameRules"
          element={<AuthAdmin cmp={GameRules} baseUrl={baseUrl} />}
        />
        <Route
          path="/payments"
          element={<AuthAdmin cmp={Payments} baseUrl={baseUrl} />}
        />
        {/* <Route path='/GameTC' element={<AuthAdmin cmp={GameTC} baseUrl={baseUrl}/>}/> */}
        <Route
          path="/user/wallet"
          element={<AuthAdmin cmp={Wallet} baseUrl={baseUrl} />}
        />
        <Route
          path="/admin/ticket"
          element={<AuthAdmin cmp={Tickets} baseUrl={baseUrl} />}
        />
        <Route
          path="/admin/gamesettings"
          element={<AuthAdmin cmp={Gamesetting} baseUrl={baseUrl} />}
        />
        <Route
          path="/admin/Setting"
          element={<AuthAdmin cmp={Setting} baseUrl={baseUrl} />}
        />
        <Route
          path="/admin/Period"
          element={<AuthAdmin cmp={Period} baseUrl={baseUrl} />}
        />
        ...
        <Route
          path="/mine"
          element={
            <AuthUser cmp={MinePage} baseUrl={baseUrl} userData={userData} />
          }
        />
        <Route
          path="/privacy/policy"
          element={<AuthUser baseUrl={baseUrl} cmp={PrivacyPolicy} />}
        />
        <Route
          path="/terms/condition"
          element={<AuthUser baseUrl={baseUrl} cmp={Terms} />}
        />
        <Route path="/about" element={<AuthUser cmp={About} />} />
        {/* <Route path='/reset/password' element={<AuthUser cpm={ResetPassword}/>}/> */}
        <Route
          path="/add/address"
          element={<AuthUser cmp={AddAddress} baseUrl={baseUrl} />}
        />
        <Route
          path="/add/bank"
          element={<AuthUser cmp={AddBankCard} baseUrl={baseUrl} />}
        />
        <Route
          path="/withdrawal"
          element={<AuthUser cmp={Withdrawal} userBalance={userBalance} />}
        />
        <Route path="/orders" element={<AuthUser cmp={Orders} />} />
        <Route
          path="/ComplaintsSuggestions"
          element={<AuthUser cmp={ComplaintsSuggestions} baseUrl={baseUrl} />}
        />
        <Route
          path="/promotion"
          element={
        ...
        <Route
          path="/RiskDisclosure"
          element={<AuthUser cmp={RiskDisclosureAgreement} baseUrl={baseUrl} />}
        />
        <Route
          path="/recharge"
          element={<AuthUser cmp={Recharge} userBalance={userBalance} />}
        />
        <Route
          path="/payment"
          element={<AuthUser cmp={Payment} baseUrl={baseUrl} />}
        />
        <Route
          path="/user/ticket"
          element={<AuthUser cmp={Ticket} baseUrl={baseUrl} />}
        />
        <Route
          path="/user/setting"
          element={<AuthUser cmp={SettingUser} baseUrl={baseUrl} />}
        />
      </Routes>
    </>
  );
