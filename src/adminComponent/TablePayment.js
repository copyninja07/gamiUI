        ...
        <>
            ...
            <div style={{ padding: '30px', display: 'block' }} id='divTable' >
                ...
                <MaterialTable
                    ...
                    columns={[
                        { title: 'Payment Heading', field: 'paymentHeading' },
                        { title: 'Payment Content', field: 'paymentContent' },
                        { title: 'Payment Image', field: 'paymentImage' },
                        { title: 'Payment Status', field: 'status' },
                        { title: 'Image Status', field: 'showImga' },
